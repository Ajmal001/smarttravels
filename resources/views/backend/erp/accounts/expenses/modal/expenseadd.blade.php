  ...
  <div class="modal-dialog">
     <div class="modal-content">
        <div class="modal-header modal-header-primary">
           ...
           <h3><i class="fa fa-calculator m-r-5"></i> Add New Expense </h3>
        </div>
        ...
        <div class="modal-body">
           <div class="row">
             <div class="panel-body">
               ...
               {!! Form::open(['method'=>'post','url' => 'adminerpexpensesadd','class'=>'col-sm-6','enctype'=>'multipart/form-data']) !!}
               {!! csrf_field() !!}
                ...
                <div class="form-group">
                   <label>Amount</label>
                   <input type="text" name="expense_amount" class="form-control" placeholder="Enter Amount" required>
                </div>

                <div class="form-group">
                   <label>Date</label>
                   <div class="input-group date form_date" >
                      <input id='minMaxExample' type="text" name="expense_date" style="z-index: 1050 !important;" class="form-control years"><span class="input-group-addon"><a href="#"><i class="fa fa-calendar"></i></a></span>
                   </div>
                </div>

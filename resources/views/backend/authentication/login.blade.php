...
<head>
        ...
        <link rel="shortcut icon" href="{{URL::asset('assets/backend/assets/dist/img/ico/favicon.png')}}" type="image/x-icon">
        <!-- Bootstrap -->
                    ...
                    <div class="panel-body">
                        <form method="POST" action="{{ route('login') }}" id="loginForm" novalidate>
							...
							<div class="form-group">
                                ...
                                <input type="email" placeholder="example@gmail.com" name="email" value="{{ old('email') }}" title="Please enter you email" required=""  class="form-control">
                            </div>

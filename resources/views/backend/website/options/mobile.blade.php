                  ...
                  <div class="col-sm-12">
                     <div class="panel panel-bd lobidrag">
                        ...
                        <div class="panel-body">
						   ...
						   {!! Form::open(['method'=>'post','url' => 'adminwebsiteoptionsmobilesave','class'=>'col-sm-6','enctype'=>'multipart/form-data']) !!}   
                               {!! csrf_field() !!}							  
							  
							  <div class="form-group">
                                 <label>Mobile</label>
                                  <input type="text" name="mobile" class="form-control" value="{{$current_option->mobile}}">
                              </div>

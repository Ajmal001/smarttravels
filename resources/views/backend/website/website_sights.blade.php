                                 ...
                                 <tbody>
                                    ...
                                    <tr>
                                       ...
                                       <td>
										    ...
										    <a class="btn btn-add btn-sm" href="adminwebsiteeditsights/{{$sl->sight_id}}"><i class="fa fa-pencil"></i></a>
										    <a class="btn btn-danger btn-sm" href="adminwebsitedeletesights/{{$sl->sight_id}}"><i class="fa fa-trash-o"></i></a>
                     ...
                     <div class="modal-content">
						...
						<div class="modal-body">
                           <div class="row">
							...
							{!! Form::open(['method'=>'post','url' => 'adminwebsiteinsertsight','class'=>'col-sm-6','enctype'=>'multipart/form-data']) !!}   
                               {!! csrf_field() !!}

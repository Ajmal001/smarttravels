         ...
         <div class="content-wrapper">
            ...
            <section class="content-header">
               ...
               <div class="header-title">
                  <h1>Operator Food Prices</h1>
                  <small>List of all Food Prices</small>
               </div>
            </section>
            <!-- Main content -->
                  ...
                  <div class="modal-dialog">
                     <div class="modal-content">
                        <div class="modal-header modal-header-primary">
                           ...
                           <h3><i class="fa fa-plane m-r-5"></i> Add Food Price </h3>
                        </div>
						...
						<div class="modal-body">
                           <div class="row">
							...
							{!! Form::open(['method'=>'post','url' => 'adminwebsiteoperatorfoodsave','class'=>'col-sm-6','enctype'=>'multipart/form-data']) !!}
                               {!! csrf_field() !!}
							  ...
							  <div class="form-group">
                                 ...
                                 <select class="form-control" name="type">
									<option value="0" disabled selected>Select Food Type</option>
									<option>Lunch</option>

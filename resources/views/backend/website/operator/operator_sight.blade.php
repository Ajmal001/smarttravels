         ...
         <div class="content-wrapper">
            ...
            <section class="content-header">
               ...
               <div class="header-title">
                  <h1>Operator Sight Prices</h1>
                  <small>List of all Sight Prices</small>
               </div>
            </section>
            <!-- Main content -->
                              ...
                              <table id="dataTableExample1" class="table table-bordered table-striped table-hover">
                                 ...
                                 <tbody>
                                    ...
                                    <tr>
                                       ...
                                       <td>
										  <a class="btn btn-danger btn-sm" href="adminwebsiteoperatorsightdelete/{{$hl->id}}"><i class="fa fa-trash-o"></i></a>
                                       </td>
                                    </tr>
									@endforeach
                                 </tbody>

         ...
         <div class="content-wrapper">
            ...
            <section class="content-header">
               ...
               <div class="header-title">
                  <h1>Operator Pic Drop Prices</h1>
                  <small>List of all Pic & Drop Prices</small>
               </div>
            </section>
            <!-- Main content -->
                     ...
                     <div class="panel panel-bd lobidrag">
                        ...
                        <!-- Plugin content:powerpoint,txt,pdf,png,word,xl -->
                           <div class="btn-group">
								...
								<a class="btn btn-add" href="#" data-toggle="modal" data-target="#package" > <i class="fa fa-plus"></i> Add New Pic & Drop Price </a>
						   </div>
                           ...
                           <div class="table-responsive">
                              <table id="dataTableExample1" class="table table-bordered table-striped table-hover">
                                 ...
                                 <tbody>
								    @foreach($operatorPicDrop as $hl)
                                    <tr>
                                       <td>{{$hl->country}}</td>
                                       <td>{{$hl->location}}</td>
                                       <td>{{$hl->price}}</td>
                                       <td>
										  <a class="btn btn-danger btn-sm" href="adminwebsiteoperatorpicdropdelete/{{$hl->id}}"><i class="fa fa-trash-o"></i></a>
                                       </td>
                                    </tr>
									@endforeach
                                 </tbody>
                              </table>
                              {{$operatorPicDrop->links()}}
                           </div>
                        </div>
                     </div>
                  </div>
                  ...
                  <div class="modal-dialog">
                     <div class="modal-content">
                        <div class="modal-header modal-header-primary">
                           ...
                           <h3><i class="fa fa-plane m-r-5"></i> Add Operator Pic & Drop </h3>
                        </div>
						...
						<div class="modal-body">
                           <div class="row">
							...
							{!! Form::open(['method'=>'post','url' => 'adminwebsiteoperatorpicdropsave','class'=>'col-sm-6','enctype'=>'multipart/form-data']) !!}
                               {!! csrf_field() !!}

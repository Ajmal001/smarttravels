	...
	<section>
		<div class="tr-register">
			<div class="tr-regi-form">
				...
				<form class="col s12" method="POST" action="{{ url('agentlogin') }}">
					{{ csrf_field() }}
				...
				<p><a href="{{url('/userforgetpass')}}">forgot password ?</a> | Are you a new user ? <a href="{{url('/agentregister')}}">Register</a>
				</p>

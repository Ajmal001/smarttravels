					...
					<div class="db-2-main-com db-2-main-com-table">	
							 ...
							 <div class="invoice-box">
									<table cellpadding="0" cellspacing="0">
												...
												<table>
													<tr>
														...
														<td>
															...
															<strong>Country:</strong> {{$v_country1}} {{$v_country2}} {{$v_country3}} {{$v_country4}}<br>                               
															<strong>Person:</strong> Adult = {{$v_person_adult}}  Child = {{$v_person_child}}  Infant = {{$v_person_infant}} <br>                               
															<strong>Duration:</strong> {{$total_duration}} Days <br>                               
															<strong>Air Ticket Cost:</strong> {{$v_air_ticket_cost}} <br>                               
														</td>
													</tr>
												</table>
											</td>
										...
										<tr class="heading">										
											<td>
											   <strong>{{$v_country1}} -</strong> Item List
											</td>
										...
										<tr class="heading">
											<td>
												...
												{{$hotel_price1}} (Per Night * {{$v_hotel_room}} Room) <br>							
											</td>
								...
								<table cellpadding="0" cellspacing="0">
										...
										<tr class="heading">
											<td>
											   <strong>{{$v_country2}} -</strong> Item List
											</td>
										...
										<tr class="heading">
											<td>
												 <strong>Hotel Price</strong><br>
												{{$hotel_price2}} (Per Night * {{$v_hotel_room}} Room) <br>							
											</td>
								...
								<table cellpadding="0" cellspacing="0">
										...
										<tr class="heading">
											<td>
											   <strong>{{$v_country3}} -</strong> Item List
											</td>
										...
										<tr class="heading">
											<td>
												 <strong>Hotel Price</strong><br>
												{{$hotel_price3}} (Per Night * {{$v_hotel_room}} Room) <br>							
											</td>
									...
									<table cellpadding="0" cellspacing="0">
										...
										<tr class="heading">
											<td>
											   <strong>{{$v_country4}} -</strong> Item List
											</td>
										...
										<tr class="heading">
											<td>
												 <strong>Hotel Price</strong><br>
												{{$hotel_price4}} (Per Night * {{$v_hotel_room}} Room) <br>							
											</td>
							...
							<tr>
								<h3 align="right">Total Tour Cost: {{$total_tour_cost}}</h3>
								<h3 align="right">Air Ticket : {{$v_air_ticket_cost}}</h3>
								<h4 align="right">Grand Total : {{$grand_total}}</h4>
							</tr>

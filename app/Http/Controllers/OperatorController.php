...
{   
	...
	public function OperatorAirTicket(){
		$countryList = TourCountry::get();
		$locationList = TourLocation::get();
		$operatorAirTicket = AirTicket::get();
